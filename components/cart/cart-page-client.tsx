        ...
        {items.length ? (
          <div className="cart-page-layout">
                ...
                return (
                  <section className="cart-store-group" key={group.storeId}>
                    ...
                    {group.items.map((item) => (
                      ...
                      >
                        ...
                        <strong className="cart-line-total">
                          C${" "}
                          {(item.price * item.quantity).toLocaleString("es-NI")}
                        </strong>
                        <button
                    ...
                    <footer>
                      ...
                      <strong>C$ {subtotal.toLocaleString("es-NI")}</strong>
                    </footer>
                  </section>
                );
              })}
              <div className="cart-whatsapp-note">
                <div>
                  <WhatsappLogo weight="fill" />
                </div>
                <span>
                  <strong>Comunicación directa con cada tienda</strong>
                  <small>
                    Al generar tu pedido podrás coordinar entrega y pago con
                    cada negocio.
                  </small>
                </span>
                <Storefront weight="duotone" />
            ...
            <aside className="cart-summary-panel">
              ...
              {groups.map((group) => (
                <div className="summary-store" key={group.storeId}>
                  <span>
              ...
              <div className="summary-row">
                <span>Envío</span>
                <strong className="free-shipping">A coordinar</strong>
              </div>
              ...
              <div className="secure-note">
                ...
                <span>
                  ...
                  <small>
                    Tus datos están protegidos y cada tienda recibe únicamente
                    su pedido.
                  </small>
                </span>
              </div>
              <Link className="continue-order" href="/checkout">
                Continuar y generar pedido <ArrowRight />
              </Link>
              <p className="no-charge">
                <LockKey /> ONDIE no realiza cobros en la plataforma
              </p>
            </aside>
          </div>
        ) : (
        ...
        <section className="cart-benefits">
          ...
          <div>
            ...
            <span>
              ...
              <small>Habla directamente con cada tienda</small>
            </span>
          </div>
          <div>
            <ShieldCheck />
            <span>
              ...
              <small>Coordina con el negocio</small>
            </span>
          </div>
        </section>
      </div>
