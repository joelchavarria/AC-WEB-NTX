...
export function OrderGenerationClient({ contacts }: { contacts: Contacts }) {
  ...
  return <main className="order-page">
    <header className="order-header"><Link href="/"><Image src="/ondie-logo.svg" alt="ONDIE" width={176} height={58} priority /></Link><label><MagnifyingGlass /><input aria-label="Buscar productos o tiendas" placeholder="Buscar productos o tiendas..." /></label><nav><Link href="/">Tiendas</Link></nav><div><CartSummary /><Link href="/account" aria-label="Mi cuenta"><UserCircle /></Link></div></header>
