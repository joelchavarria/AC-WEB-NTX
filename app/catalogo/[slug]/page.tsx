...
export default async function ExclusiveStorePage({
  ...
  return <><JsonLd data={{ "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "ONDIE", item: siteUrl.href }, { "@type": "ListItem", position: 2, name: store.name, item: new URL(`/stores/${encodeURIComponent(store.slug)}`, siteUrl).href }] }} /><StorefrontClient store={store} exclusive /></>;
}
